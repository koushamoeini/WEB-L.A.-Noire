...
const Dashboard = () => {
  ...
  const modules = [
    ...
    },
    {
      ...
      icon: '📊',
      path: '/stats',
      description: 'گزارش جامع پرونده‌ها برای بررسی قضایی و مدیریتی ).',
      roles: ['judge', 'qazi', 'sergeant', 'captain', 'police_chief'],
    },
    {
      id: 'evidence',
      ...
      icon: '🧾',
      path: '/evidence',
      description: 'مدیریت شواهد پرونده‌ها و تایید مدارک زیستی توسط پزشک قانونی ).',
      roles: [
        'trainee',
        'police_officer',
        'detective',
