...
import './CaseDetail.css'; // Reusing styles
...
export default function Trial() {
  ...
  if (loading) return <div className="layout-with-sidebar"><Sidebar /><div className="main-content"><p>در حال بارگذاری...</p></div></div>;
